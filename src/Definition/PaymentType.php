...
final class PaymentType
{
    public const
        ...
        MOLLIE                   = 'pm_mollie',
        MOLLIE_APPLEPAY          = 'pm_mollie_applepay',
        MOLLIE_BANCONTACT        = 'pm_mollie_bancontact',
        MOLLIE_BANKTRANSFER      = 'pm_mollie_banktransfer',
        MOLLIE_BELFIUS           = 'pm_mollie_belfius',
        MOLLIE_BILLIE            = 'pm_mollie_billie',
        MOLLIE_BITCOIN           = 'pm_mollie_bitcoin',
        MOLLIE_CREDITCARD        = 'pm_mollie_creditcard',
        MOLLIE_DIRECTDEBIT       = 'pm_mollie_directdebit',
        MOLLIE_EPS               = 'pm_mollie_eps',
        MOLLIE_GIFTCARD          = 'pm_mollie_giftcard',
        MOLLIE_GIROPAY           = 'pm_mollie_giropay',
        MOLLIE_IDEAL             = 'pm_mollie_ideal',
        MOLLIE_INGHOMEPAY        = 'pm_mollie_inghomepay', // discontinued since February 1st, 2021
        MOLLIE_KBC               = 'pm_mollie_kbc',
        MOLLIE_KLARNA_PAY_LATER  = 'pm_mollie_klarnapaylater',
        MOLLIE_KLARNA_PAY_NOW    = 'pm_mollie_klarnapaynow',
        MOLLIE_KLARNA_SLICE_IT   = 'pm_mollie_klarnasliceit',
        MOLLIE_MYBANK            = 'pm_mollie_mybank',
        MOLLIE_PAYPAL            = 'pm_mollie_paypal',
        MOLLIE_PAYSAFECARD       = 'pm_mollie_paysafecard',
        MOLLIE_PRZELEWY24        = 'pm_mollie_przelewy24',
        MOLLIE_PODIUMCADEAUKAART = 'pm_mollie_podiumcadeaukaart', // deprecated
        MOLLIE_SOFORT            = 'pm_mollie_sofort',
        MOLLIE_IN3               = 'pm_mollie_in3',
        MOLLIE_POINT_OF_SALE     = 'pm_mollie_pointofsale',
        ...
        PAYPAL_RATEPAY           = 'pm_paypal_ratepay',
