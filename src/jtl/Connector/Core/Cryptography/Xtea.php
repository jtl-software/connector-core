 ...
 * Usage:
 * <?php/*
 * PHP Implementation of XTEA (www.php-einfach.de) XTEA was designed in 1997 by
 * David Wheeler and Roger Needham of the Cambridge Computer Laboratory. It is
 * not subject to any patents. It is a 64-bit Feistel cipher, consisting of 64
 * rounds. XTA has a key length of 128 bits. *********************** Diese
 * Implementierung darf frei verwendet werden, der Autor uebernimmt keine
 * Haftung fuer die Richtigkeit, Fehlerfreiheit oder die Funktionsfaehigkeit
 * dieses Scripts. Benutzung auf eigene Gefahr. Ueber einen Link auf
...
final class Xtea implements ICryptography
{
    ...
    public function decrypt($text)
    {
        ...
        for ($i; $i < count($cipher); $i += 2) {
            ...
            // Xor Verknuepfung von $return und Geheimtext aus von den letzten
            // beiden Bloecken
