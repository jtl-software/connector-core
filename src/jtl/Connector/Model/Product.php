...
class Product extends DataModel
{
    ...
    protected $propertyInfos = array(
        ...
        'availableFrom' => '\jtl\Connector\Model\DateTime',
        'sort' => 'integer',
        'productWeight' => 'float',
        ...
        'asin' => 'string',
        'takeOffQuantity' => 'float',
        'upc' => 'string',
        'epId' => 'string',
        'measurementQuantity' => 'float',
        'basePriceQuantity' => 'float',
        'width' => 'float',
        'height' => 'float',
        'length' => 'float',
        ...
        'isDivisible' => 'boolean',
        'permitNegativeStock' => 'boolean',
        'considerVariationStock' => 'boolean',
        'considerBasePrice' => 'boolean',
        'taxClassId' => '\jtl\Connector\Model\Identity',
        'shippingClassId' => '\jtl\Connector\Model\Identity',
        'varCombinationId' => '\jtl\Connector\Model\Identity',
        'masterProductId' => '\jtl\Connector\Model\Identity',
        'isMasterProduct' => 'boolean',
        'setArticleId' => '\jtl\Connector\Model\Identity',
        'productTypeId' => '\jtl\Connector\Model\Identity',
        'hasBestBefore' => 'boolean',
        'measurementUnitId' => '\jtl\Connector\Model\Identity',
