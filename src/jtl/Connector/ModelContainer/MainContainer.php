...
final class MainContainer
{
    ...
    public static $mappings = array(
        ...
        'cross_selling' => array('global_data', 'GlobalData'),
        'cross_selling_group' => array('global_data', 'GlobalData'),
        'unit' => array('global_data', 'GlobalData'),
        'unit_i18n' => array('global_data', 'GlobalData'),
        'measurement' => array('global_data', 'GlobalData'),
        'measurement_i18n' => array('global_data', 'GlobalData'),
        ...
        'set_article' => array('global_data', 'GlobalData'),
