...
class CustomerOrder extends DataType
{
    protected function loadProperties()
    {
        return array(
            ...
            new PropertyInfo('billingAddress', 'CustomerOrderBillingAddress', null, false, false, false),
            new PropertyInfo('carrierName', 'string', '', false, false, false),
            new PropertyInfo('creationDate', 'DateTime', null, false, false, false),
            new PropertyInfo('credit', 'double', 0.0, false, false, false),
            ...
            new PropertyInfo('paymentInfo', 'CustomerOrderPaymentInfo', null, false, false, false),
            new PropertyInfo('paymentModuleCode', 'string', '', false, false, false),
            new PropertyInfo('paymentStatus', 'string', '', false, false, false),
            new PropertyInfo('shippingAddress', 'CustomerOrderShippingAddress', null, false, false, false),
            ...
            new PropertyInfo('shippingStatus', 'string', '', false, false, false),
