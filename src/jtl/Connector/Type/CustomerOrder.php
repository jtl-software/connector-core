...
class CustomerOrder extends DataType
{
    protected function loadProperties()
    {
        return array(
            ...
            new PropertyInfo('billingAddress', 'CustomerOrderBillingAddress', '', false, false, false),
            ...
            new PropertyInfo('paymentInfo', 'CustomerOrderPaymentInfo', '', false, false, false),
            new PropertyInfo('shippingAddress', 'CustomerOrderShippingAddress', '', false, false, false),
